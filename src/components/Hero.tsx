...
export default function Hero() {
  ...
  wbe3萌新之旅<br className="md:hidden" />从入门到精通
</h1>
              <p className="text-lg md:text-xl text-gray-300 mb-8 max-w-4xl mx-auto">
                专为wbe3新手打造的系统化学习平台，从基础概念到高级技巧，助你快速了解加密货币与相关技术知识。
             </p>
          </motion.div>
          ...
          >
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-gray-400 mt-1">空投类型</p>
               ...
               {/* 免责声明区域 */}
               <div 
                 className="mt-6 flex items-center justify-center bg-gradient-to-r from-blue-600 to-indigo-600 px-5 py-2.5 rounded-xl shadow-lg shadow-blue-500/30 border border-blue-500/50"
               >
                  <div className="text-white font-bold text-base">本站内容仅供学习参考，不构成任何投资建议。</div>
               </div>
        </div>
      </div>
    </section>
