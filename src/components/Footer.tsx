  ...
  return (
    <footer className="bg-gray-900 text-gray-400 pt-16 pb-8 border-t border-gray-800">
      <div className="container mx-auto px-4 md:px-6">
        ...
        <span className="text-xl font-bold bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent">wbe3萌新之旅</span>
            </div>
          ...
          <div>
            ...
            <div className="bg-gray-800 p-3 rounded-lg border border-gray-700">
              <p className="text-xs text-gray-500">
               © {currentYear} wbe3萌新之旅. 所有内容仅供学习参考.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-gray-800 pt-8 mt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-500 text-sm mb-4 md:mb-0">
               &copy; {currentYear} wbe3萌新之旅. 保留所有权利.
            </p>
